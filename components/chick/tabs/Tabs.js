        ...
        <ul>
          <li title="Vaccine">
            <label htmlFor="tab1" role="button">
              ...
              <img id="tab1img" src="./images/chickicon.png/" alt="" />
              <br />
              <span>راس 308</span>
            </label>
          </li>
          <li title="Vitamins">
            <label htmlFor="tab2" role="button">
              <img id="tab1img" src="./images/hobard.png/" alt="" />
              <br />
              <span>آرین</span>
            </label>
          </li>
          <li title="AntiBiotic">
            <label htmlFor="tab3" role="button">
              <img id="tab1img" src="./images/chick99.png/" alt="" />
              <br />
              <span>هوبارد</span>
            </label>
          </li>
          <li title="Sublomentries">
            <label htmlFor="tab4" role="button">
              <img id="tab1img" src="./images/chii.png/" alt="" />
              <br />
              <span>کاب500</span>
            </label>
          </li>
