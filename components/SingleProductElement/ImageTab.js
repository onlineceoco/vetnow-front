    ...
    <div>
      <main className={imageTab["main"]}>
        ...
        <div id={imageTab["content"]}>
          ...
          <div id="tabs">
            <label id="tab1" style={{backgroundImage: `url("/images/bag.png")`}} htmlFor={imageTab["radio1"]}></label>
            <label id="tab2" htmlFor={imageTab["radio2"]}></label>
            <label id="tab3" htmlFor={imageTab["radio3"]}></label>
            <label id="tab4" htmlFor={imageTab["radio4"]}></label>
          </div>
      </main>
      <style jsx>
        {`{
