...
export const menuItems = [
  ...
  },
  {
    ...
    subMenus: [
      ...
      { name: "طرح توجیهی و کار آفرینی", to: "/adviser/resome" },
    ],
  },
  {
    name: "اتوماسیون",
    ...
    subMenus: [
      ...
      { name: "سخت افزار و تجهیزات ایترنت اشیا", to: "/automation/hardware" },
      { name: "سیستم های روباتیک", to: "/automation/advice_training" },
