        ...
        <ul>
          <li title="Vaccine">
            <label htmlFor="tab1" role="button">
              ...
              <img id="tab1img" src="./images/vaccine.svg/" alt="" />
              <br />
              <span>واکسن</span>
            </label>
          </li>
          <li title="Vitamins">
            <label htmlFor="tab2" role="button">
              <img id="tab1img" src="./images/vit.png/" alt="" />
              <br />
              <span>ویتامین</span>
            </label>
          </li>
          <li title="AntiBiotic">
            <label htmlFor="tab3" role="button">
              <img id="tab1img" src="./images/pill.png/" alt="" />
              <br />
          ...
          <li title="Sublomentries">
            <label htmlFor="tab4" role="button">
              <img id="tab1img" src="./images/sup.png/" alt="" />
              <br />
              <span>افزودنی</span>
            </label>
          </li>
          <li title="Cleaner">
            <label htmlFor="tab5" role="button">
              <img id="tab1img" src="./images/spry.png/" alt="" />
              <br />
              <span>ضدعفونی کننده</span>
            </label>
          </li>
        </ul>
