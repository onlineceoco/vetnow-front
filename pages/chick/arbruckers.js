  ...
  return (
    <div>
      <Products
        ...
        chartCategories={[1390, 1391, 1392, 1393, 1394]}
        chartData={[
          {
            name: "کاب 500",
            data: [11, 12, 13, 24, 15],
...
export async function getStaticProps(context) {
  const url = encodeURI("products?category=آبراکرز پلاس");
  try {
