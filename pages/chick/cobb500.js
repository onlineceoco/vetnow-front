    ...
    <div>
      <Products
        ...
        chartData={[
            ...
            chartWidth="100%"
            chartHeight="300px"
            aboutrace="نژاد کاب هم اکنون یکی از گسترده ترین مرغ گوشتی جهان است و خاستگاه آن ایالت ماساچوست آمریکا می باشد. در گله های کاب بدلیل وزن گیری مشابه مرغ و خروس رقابت غذایی بندرت مشاهده می گردد که خود یکنواختی گله را افزایش می دهد. کمتر بودن 2 درصدی نیاز این سویه به حداقل میزان پروتین برای تکمیل دوره باعث ارزان تر شدن جیره طول دوره شده که کاهش هزینه های پرورشی را برای مرغدار در پی دارد. این سویه در 35 روزگی به وزن 2 کیلوگرم رسیده و افت کشتارگاهی لاشه آن 2 درصد کمتر از سایر سویه ها می باشد. با رعایت شرایط نگهداری و پرورشی اعلام شده از طرف محققین ضریب تبدیل 5/1 قابل تجربه است."
    // Chart Data End
        img1Slider="/images/Cob500.jpg" 
        img2Slider="/images/cob700.jpg" 
        img3Slider="/images/cobmale.jpg"
        title1Banner="کاب 500 "
