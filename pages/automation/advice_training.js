...
const Advice_training = () => {
    return (
        <div>
            <Products 
            leftSideBgColor="#BBBBBB"
            rightSideBgColor="#393E46"
            displatChart="none"
            img1Slider="/images/anti-2.jpg" 
            img2Slider="/images/anti3.jpg" 
            img3Slider="/images/aniti4.jpg" 
            title1Banner="ویتامین و آنتی بیوتیکها "
            img2Banner="/images/aaaaa.png"
            title2Banner="مرجع کامل مولتی ویتامین طیور"
            subtitle2Banner="100% Orginal"
            title3Banner="کبد و کلیه شور"
            img3Banner='/images/b3.png'
            subtitle3Banner="10% تخفیف کیف پول"
            title4Banner="پروبیوتیک"
            img4Banner='/images/probiotic.png'
...
export default Advice_training
