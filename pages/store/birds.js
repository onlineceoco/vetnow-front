  ...
  return (
    <div>
      <Products
        ...
        displatChart="none"
        img1Slider="/images/bird010.jpg"
        img2Slider="/images/bird011.jpg"
        img3Slider="/images/bird03.jpg"
        title1Banner="پرندگانی زینتی "
        img2Banner="/images/birdfeed012.png"
        title2Banner="مرجع کامل دان های تخصصی"
        subtitle2Banner="100% Orginal"
        title3Banner="با صرفه تر از همیشه"
        img3Banner="/images/feed0124.png"
        subtitle3Banner="10% تخفیف کیف پول"
        title4Banner="همه ی نیازهای غذایی"
        img4Banner="/images/feed0123.png"
        subtitle4Banner="20 درصد تخفیف ویژه"
        title5Banner="ظرف دان پرندگان آزاد "
        img5Banner="/images/birdfeeder01.png"
        subtitle5Banner="زیبا - کاربردی"
...
export async function getStaticProps(context) {
  const url = encodeURI("products?category=پرندگان زینتی");
  try {
