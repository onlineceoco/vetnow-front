  ...
  return (
    <div>
      <Products
        ...
        displatChart="none"
        img1Slider="/images/pellet01.jpg"
        img2Slider="/images/pelet124.jpg"
        img3Slider="/images/pelet123.jpg"
        title1Banner="کنسانتره و دان آماده "
...
export async function getStaticProps(context) {
  const url = encodeURI("products?category=دان آماده");
